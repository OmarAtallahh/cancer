            ...
            <div class="row">
              <div class="col-xl-9 col-lg-10 mx-auto">
                <div class="bg-faded rounded p-5">
                  ...
                  <p>
                  here you can edit all information of doctors.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-5 col-md-push-1">
                  <div class="form-body">
                      ...
                      <div class="form-group">
                        <label class="form_controls">Password</label>
                          <div class="input-group">
                            <span class="input-group-addon">
                      ...
                      <div class="form-group">
                        <label class="form_controls">Country</label>
